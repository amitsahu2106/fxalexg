...
fail(“OANDA 401 - API Key is wrong. Regenerate on oanda.com”)
elif r.status_code == 404:
fail(“OANDA 404 - Account ID is wrong. Check oanda.com dashboard”)
else:
fail(“OANDA error “ + str(r.status_code))
except Exception as e:
fail(“OANDA connection failed: “ + str(e))

print(”\n[3] Testing OANDA Live EUR/USD Data…”)
try:
r = requests.get(
...
ok(“OANDA live data working! EUR/USD: “ + str(last))
else:
...
if candles:
last = candles[-1][“mid”][“c”]
ok(“XAU/USD working! Gold: $” + str(last))
else:
fail(“XAU/USD empty candles”)
elif r.status_code == 400:
fail(“XAU/USD not available on your demo account”)
else:
...
fail(“Telegram 401 - Bot token wrong. Get new one from @BotFather”)
else:
...
try:
msg = (
“FXAlexG Diagnostic Test PASSED\n\n”
“All 3 components working:\n”
“- OANDA: connected\n”
“- Gemini AI: connected\n”
“- Telegram: connected\n\n”
“Bot is alive and scanning every 5 mins!\n”
...
print(”=” * 50)
if failed == 0:
print(“All systems OK! Bot will alert when A+/B+ setups appear.”)
else:
